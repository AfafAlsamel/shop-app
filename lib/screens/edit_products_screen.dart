...
class _EditUserProductScreenState extends State<EditUserProductScreen> {
  ...
  Future<void> _submmitedForm() async {
    ...
    await  Provider.of<Products>(context, listen: false)
      ...
      try {
        await Provider.of<Products>(context, listen: false)
            .addProduct(_emptyProduct);
      } catch (error) {
        return showDialog(
          context: context,
          builder: (ctx) => AlertDialog(
            title: Text('Error Occured'),
            content: Text('Something go erong'),
            actions: [
              FlatButton(
                child: Text('Ok'),
                onPressed: () {
                ...
                child: ListView(
                  children: [
                    TextFormField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Title Of Your Product'),
                    ...
                    TextFormField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Price Of Your Product'),
                      textInputAction: TextInputAction.next,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextFormField(
                            decoration: InputDecoration(
                                labelText: 'Image Of Your Product'),
